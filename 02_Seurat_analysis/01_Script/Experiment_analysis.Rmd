...
```{r,eval=FALSE}
knit( "/home/nozaism/Workspace/01_These/01_Project/Myc_Pten_Paper/Myc_Repo_2/02_Seurat_analysis/01_Script/Experiment_analysis.Rmd", "/home/nozaism/Workspace/01_These/01_Project/Myc_Pten_Paper/Myc_Repo_2/02_Seurat_analysis/02_Output/Experiment_analysis.html" )
```
...
### Cluster 12
```{r cluster12,fig.width = 10, fig.height = 8}
...
```{r}
## Cell cycle
cc.genes <- readRDS(file = "/home/nozaism/Workspace/01_These/01_Project/Myc_Pten_Paper/Myc_Repo_2/02_Seurat_analysis/01_Script/mouse_cell_cycle_genes.rds")
#Assign Cell-Cycle Scores
T.Seurat <- CellCycleScoring(object = T.Seurat, s.features = cc.genes$s.genes, g2m.features = cc.genes$g2m.genes, set.ident = TRUE)


####### VOIR QUEL PLOT GARDE POUR MONTRER NV CYCLE DP BLAST
 ...
 Tsne<-data.frame(
  ...
  ggplotly(DimPlot(T.Seurat, reduction = "umap", do.label = TRUE, pt.size = 1))  
...
genecomprow <- read.table("/home/nozaism/Workspace/01_These/01_Project/Myc_Pten_Paper/Myc_Repo_2/02_Seurat_analysis/01_Script/cluster1v4.txt", sep = "\t")
...
genecomprow <- read.table("/home/nozaism/Workspace/01_These/01_Project/Myc_Pten_Paper/Myc_Repo_2/02_Seurat_analysis/01_Script/cluster0vs12.txt", sep = "\t")
genecomprow$x = as.character(genecomprow$x)
genecomprow <- genecomprow[,1]
####
